...
export default function WhatsAppShareButton({
  ...
  return (
    <a
      ...
      aria-busy={sharing}
      className="flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] py-3 text-base font-medium text-white transition-colors hover:bg-[#20bd5a] active:scale-95 md:hidden disabled:opacity-70"
    >
